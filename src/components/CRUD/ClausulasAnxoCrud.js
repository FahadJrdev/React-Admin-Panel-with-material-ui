...
const Lists = [
  {
    item2: "Vigencia de contrato", 
    item3: "Obligatoria", 
    item4: "Establece antecedentes de la fecha del contrato al que accedé",
    item5: "NO",
    status:"Active"
  },
  {
    item2: "Vigencias de Clausulas del Contrato", 
    item3: "Obligatoria", 
    item4: "Establece constancia de que el contrato original se mantiene en todo lo que no se ha alterado por el anexo.",
    item5: "SI",
    status:"Active"
  },
  {
    item2: "Modificación de Remuneración", 
    item3: "Opcional", 
    item4: "Modifica la remuneración a percibir por parte del trabajador.",
    item5: "SI",
    status:"banned"
  }
];
...
const TABLE_HEAD = [
  ...
  { id: 'item5', label: 'Modificable', alignCenter: false },
  { id: 'item' },
];
...
export default function ClausulasAnxoCrud({setAttemptToAdd, setAttemptToEdit}) {
