...
const Lists = [
  {
    item1: "COMP", 
    item2: "Bono Producción", 
    item3: "Haber Imponible", 
    item4: "01-01-2022",
    item5: "Indefinido",
    status:"Active"
  },
...
const TABLE_HEAD = [
  { id: 'item1', label: 'Código', alignCenter: true },
  { id: 'item2', label: 'Nombre', alignCenter: false },
  { id: 'item3', label: 'Tipo', alignCenter: false },
  { id: 'item4', label: 'Fecha Desde', alignCenter: false },
  { id: 'item5', label: 'Fecha Hasta', alignCenter: false },
  { id: 'item' },
];
...
export default function HaberCrud({setAttemptToAdd, setAttemptToEdit}) {
