...
const Lists = [
  {
    item1: "Plantilla de Contrato", 
    item2: "Modelo de Contrato Estándar",
    status:"Active"
  },
];

const TABLE_HEAD = [
  { id: 'item1', label: 'Nombre', alignCenter: true },
  { id: 'item2', label: 'Descripción', alignCenter: false },
  { id: 'item' },
];
...
export default function TipoContratoCrud({setAttemptToAdd, setAttemptToEdit}) {
